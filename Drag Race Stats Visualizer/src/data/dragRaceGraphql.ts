...
const seasonRecords: SeasonRecord[] = [
  ...
  {
    id: 13,
    name: 'RuPaul’s Drag Race Season 13',
    year: 2021,
  },
  {
    id: 14,
    name: 'RuPaul’s Drag Race Season 14',
    year: 2022,
  },
]
...
const guestRecords: GuestRecord[] = [
  ...
  { id: 231, name: 'Nicole Byer' },
  { id: 232, name: 'Loni Love' },
  { id: 233, name: 'Ts Madison' },
  { id: 234, name: 'Jamal Sims' },
  { id: 235, name: 'Anne Hathaway' },
  { id: 236, name: 'Ali Wong' },
  { id: 237, name: 'Utkarsh Ambudkar' },
  { id: 238, name: 'Todrick Hall' },
  { id: 239, name: 'Tia Mowry' },
  { id: 240, name: 'Aisha Tyler' },
  { id: 241, name: 'Lizzo' },
  { id: 242, name: 'Michelle Visage' },
  { id: 243, name: 'Cheryl Canning' },
  { id: 244, name: 'Scarlett Johansson' },
  { id: 245, name: 'Alicia Keys' },
  { id: 246, name: 'Loni Love' },
  { id: 247, name: 'Symone Sanders' },
  { id: 248, name: 'Norvina' },
  { id: 249, name: 'Kacey Musgraves' },
  { id: 250, name: 'Tiffany “New York” Pollard' },
  { id: 251, name: 'Lizzo' },
  { id: 252, name: 'Alicia Keys' },
  { id: 253, name: 'Taraji P. Henson' },
  { id: 254, name: 'Ava Max' },
  { id: 255, name: 'Dulcé Sloan' },
  { id: 256, name: 'Andra Day' },
  { id: 257, name: 'Nicole Byer' },
  { id: 258, name: 'Leslie Jordan' },
  { id: 259, name: 'Loni Love' },
  { id: 260, name: 'Dove Cameron' },
  { id: 261, name: 'Chloe Bailey' },
  { id: 262, name: 'Cheyenne Jackson' },
  { id: 263, name: 'TS Madison' },
  { id: 264, name: 'Dianne Warren' },
  { id: 265, name: 'RuPaul' },
  { id: 266, name: 'Jamal Sims' },
  { id: 267, name: 'Angie Harmon' },
  { id: 268, name: 'Christine Chiu' },
  { id: 269, name: 'Devean George' },
  { id: 270, name: 'Jeff Goldblum' },
]
...
const guestJudgeRecords: GuestJudgeRecord[] = [
  ...
  ...guestRecords.slice(214, 230).map((guest) => ({
    guestId: guest.id,
    seasonId: 12,
  })),
  ...guestRecords.slice(230, 250).map((guest) => ({
    guestId: guest.id,
    seasonId: 13,
  })),
  ...guestRecords.slice(250).map((guest) => ({
    guestId: guest.id,
    seasonId: 14,
  })),
]
...
const appearanceRecords: AppearanceRecord[] = [
  ...
  { queenId: 157, seasonId: 13, placement: 'Winner' },
  { queenId: 158, seasonId: 13, placement: 'Runner-Up' },
  { queenId: 159, seasonId: 13, placement: '3rd Place' },
  { queenId: 160, seasonId: 13, placement: '4th Place' },
  { queenId: 161, seasonId: 13, placement: '5th Place' },
  { queenId: 162, seasonId: 13, placement: '6th Place' },
  { queenId: 163, seasonId: 13, placement: '7th Place' },
  { queenId: 164, seasonId: 13, placement: '8th Place' },
  { queenId: 165, seasonId: 13, placement: '9th Place' },
  { queenId: 166, seasonId: 13, placement: '10th Place' },
  { queenId: 167, seasonId: 13, placement: '11th Place' },
  { queenId: 168, seasonId: 13, placement: '12th Place' },
  { queenId: 169, seasonId: 13, placement: '13th Place' },
  { queenId: 170, seasonId: 14, placement: 'Winner' },
  { queenId: 171, seasonId: 14, placement: 'Runner-Up' },
  { queenId: 172, seasonId: 14, placement: '3rd/4th/5th Place' },
  { queenId: 173, seasonId: 14, placement: '3rd/4th/5th Place' },
  { queenId: 174, seasonId: 14, placement: '3rd/4th/5th Place' },
  { queenId: 175, seasonId: 14, placement: '6th Place' },
  { queenId: 176, seasonId: 14, placement: '7th Place' },
  { queenId: 177, seasonId: 14, placement: '8th Place' },
  { queenId: 178, seasonId: 14, placement: '9th Place' },
  { queenId: 179, seasonId: 14, placement: '10th Place' },
  { queenId: 180, seasonId: 14, placement: '11th Place' },
  { queenId: 181, seasonId: 14, placement: '12th Place' },
  { queenId: 182, seasonId: 14, placement: '13th Place / Medical Withdrawal' },
  { queenId: 183, seasonId: 14, placement: '14th Place' },
]
