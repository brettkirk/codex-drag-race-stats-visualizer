...
const seasonRecords: SeasonRecord[] = [
  ...
  {
    id: 15,
    name: 'RuPaul’s Drag Race Season 15',
    year: 2023,
  },
  {
    id: 16,
  ...
  {
    id: 18,
    name: 'RuPaul’s Drag Race Season 18',
    year: 2026,
  },
]
...
const guestRecords: GuestRecord[] = [
  ...
  { id: 271, name: 'Ariana Grande' },
  { id: 272, name: 'Ali Wong' },
  { id: 273, name: 'Maren Morris' },
  { id: 274, name: 'Janelle Monáe' },
  { id: 275, name: 'Megan Stalter' },
  { id: 276, name: 'Orville Peck' },
  { id: 277, name: 'Julia Garner' },
  { id: 278, name: 'Amandla Stenberg' },
  { id: 279, name: 'Hayley Kiyoko' },
  { id: 280, name: 'Jordin Sparks' },
  { id: 281, name: 'Connie Britton' },
  { id: 282, name: 'Love Connie' },
  { id: 283, name: 'JoJo Siwa' },
  { id: 284, name: 'Thelma Houston' },
  { id: 285, name: 'Atsuko Okatsuka' },
  { id: 286, name: 'Sarah Michelle Gellar' },
  { id: 287, name: 'Alicia Silverstone' },
  { id: 288, name: 'Leland' },
  { id: 289, name: 'Cheyenne Jackson' },
  { id: 290, name: 'TS Madison' },
  { id: 291, name: 'Todrick Hall' },
  { id: 292, name: 'Charlize Theron' },
  { id: 293, name: 'Isaac Mizrahi' },
  { id: 294, name: 'Jamal Sims' },
  { id: 295, name: 'Law Roach' },
  { id: 296, name: 'Becky G' },
  { id: 297, name: 'Icona Pop' },
  { id: 298, name: 'Sarah Michelle Gellar' },
  { id: 299, name: 'Adam Shankman' },
  { id: 300, name: 'Xunami Muse' },
  { id: 301, name: 'Kelsea Ballerini' },
  { id: 302, name: 'Joel Kim Booster' },
  { id: 303, name: 'Ayo Edebiri' },
  { id: 304, name: 'Colman Domingo' },
  { id: 305, name: 'Megan Thee Stallion' },
  { id: 306, name: 'Kumail Nanjiani' },
  { id: 307, name: 'Kaia Gerber' },
  { id: 308, name: 'Alexis Michelle' },
  { id: 309, name: 'Suki Waterhouse' },
  { id: 310, name: 'Mayan Lopez' },
  { id: 311, name: 'Stephanie Hsu' },
  { id: 312, name: 'Keke Palmer' },
  { id: 313, name: 'Ncuti Gatwa' },
  { id: 314, name: 'Hunter Schafer' },
  { id: 315, name: 'Orville Peck' },
  { id: 316, name: 'Ts Madison' },
  { id: 317, name: 'Katy Perry' },
  { id: 318, name: 'Doechii' },
  { id: 319, name: 'Sandra Bernhard' },
  { id: 320, name: 'Julia Schlaepfer' },
  { id: 321, name: 'Paul W. Downs' },
  { id: 322, name: 'Hunter Schafer' },
  { id: 323, name: 'Quinta Brunson' },
  { id: 324, name: 'Adam Lambert' },
  { id: 325, name: 'Betsey Johnson' },
  { id: 326, name: 'Whitney Cummings' },
  { id: 327, name: 'Sam Smith' },
  { id: 328, name: 'Jerrod Carmichael' },
  { id: 329, name: 'June Diane Raphael' },
  { id: 330, name: 'Tracee Ellis Ross' },
  { id: 331, name: 'Law Roach' },
  { id: 332, name: 'Cardi B' },
  { id: 333, name: 'Dove Cameron' },
  { id: 334, name: 'Miley Cyrus' },
  { id: 335, name: 'Teyana Taylor' },
  { id: 336, name: 'Benny Blanco' },
  { id: 337, name: 'Hunter Schafer' },
  { id: 338, name: 'Quinta Brunson' },
  { id: 339, name: 'Law Roach' },
  { id: 340, name: 'Jamal Sims' },
]
...
const guestJudgeRecords: GuestJudgeRecord[] = [
  ...
  ...guestRecords.slice(250, 270).map((guest) => ({
    guestId: guest.id,
    seasonId: 14,
  })),
  ...guestRecords.slice(270, 291).map((guest) => ({
    guestId: guest.id,
    seasonId: 15,
  })),
  ...guestRecords.slice(291, 316).map((guest) => ({
    guestId: guest.id,
    seasonId: 16,
  })),
  ...guestRecords.slice(316, 331).map((guest) => ({
    guestId: guest.id,
    seasonId: 17,
  })),
  ...guestRecords.slice(331).map((guest) => ({
    guestId: guest.id,
    seasonId: 18,
  })),
]
...
const appearanceRecords: AppearanceRecord[] = [
  ...
  { queenId: 184, seasonId: 15, placement: 'Winner' },
  { queenId: 185, seasonId: 15, placement: 'Runner-Up' },
  { queenId: 186, seasonId: 15, placement: '3rd/4th Place' },
  { queenId: 187, seasonId: 15, placement: '3rd/4th Place' },
  { queenId: 188, seasonId: 15, placement: '5th Place' },
  { queenId: 189, seasonId: 15, placement: '6th Place' },
  { queenId: 190, seasonId: 15, placement: '7th Place' },
  { queenId: 191, seasonId: 15, placement: '8th Place' },
  { queenId: 192, seasonId: 15, placement: '9th Place' },
  { queenId: 193, seasonId: 15, placement: '10th Place' },
  { queenId: 194, seasonId: 15, placement: '11th Place' },
  { queenId: 195, seasonId: 15, placement: '12th Place' },
  { queenId: 196, seasonId: 15, placement: '13th Place' },
  { queenId: 197, seasonId: 15, placement: '14th Place' },
  { queenId: 198, seasonId: 15, placement: '15th Place' },
  { queenId: 199, seasonId: 15, placement: '16th Place' },
  { queenId: 200, seasonId: 16, placement: 'Winner' },
  { queenId: 201, seasonId: 16, placement: 'Runner-Up' },
  { queenId: 202, seasonId: 16, placement: '3rd Place' },
  { queenId: 203, seasonId: 16, placement: '4th Place' },
  { queenId: 204, seasonId: 16, placement: '5th Place' },
  { queenId: 205, seasonId: 16, placement: '6th Place' },
  { queenId: 206, seasonId: 16, placement: '7th Place' },
  { queenId: 207, seasonId: 16, placement: '8th Place' },
  { queenId: 208, seasonId: 16, placement: '9th Place' },
  { queenId: 209, seasonId: 16, placement: '10th Place' },
  { queenId: 210, seasonId: 16, placement: '11th Place' },
  { queenId: 211, seasonId: 16, placement: '12th Place' },
  { queenId: 212, seasonId: 16, placement: '13th Place' },
  { queenId: 213, seasonId: 16, placement: '14th Place' },
  { queenId: 214, seasonId: 17, placement: 'Winner' },
  { queenId: 215, seasonId: 17, placement: 'Runner-Up' },
  { queenId: 216, seasonId: 17, placement: '3rd/4th Place' },
  { queenId: 217, seasonId: 17, placement: '3rd/4th Place' },
  { queenId: 218, seasonId: 17, placement: '5th Place' },
  { queenId: 219, seasonId: 17, placement: '6th Place' },
  { queenId: 220, seasonId: 17, placement: '7th Place / Miss Congeniality' },
  { queenId: 221, seasonId: 17, placement: '8th Place' },
  { queenId: 222, seasonId: 17, placement: '9th Place' },
  { queenId: 223, seasonId: 17, placement: '10th Place' },
  { queenId: 224, seasonId: 17, placement: '11th Place' },
  { queenId: 225, seasonId: 17, placement: '12th Place' },
  { queenId: 226, seasonId: 17, placement: '13th Place' },
  { queenId: 227, seasonId: 17, placement: '14th Place' },
  { queenId: 228, seasonId: 18, placement: 'Winner' },
  { queenId: 229, seasonId: 18, placement: 'Runner-Up' },
  { queenId: 230, seasonId: 18, placement: '3rd Place' },
  {
    queenId: 231,
    seasonId: 18,
    placement: '4th Place / Queen of She Done Already Done Had Herses',
  },
  {
    queenId: 232,
    seasonId: 18,
    placement: '5th Place / Miss Congeniality',
  },
  { queenId: 233, seasonId: 18, placement: '6th Place' },
  { queenId: 234, seasonId: 18, placement: '7th Place' },
  { queenId: 235, seasonId: 18, placement: '8th Place' },
  { queenId: 236, seasonId: 18, placement: '9th Place' },
  { queenId: 237, seasonId: 18, placement: '10th Place' },
  { queenId: 238, seasonId: 18, placement: '11th Place' },
  { queenId: 239, seasonId: 18, placement: '12th Place' },
  { queenId: 240, seasonId: 18, placement: '13th Place' },
  { queenId: 241, seasonId: 18, placement: '14th Place' },
]
